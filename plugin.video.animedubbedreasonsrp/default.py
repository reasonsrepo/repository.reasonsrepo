...
addon_id='plugin.video.animedubbedreasonsrp'
...
enbdubbed = selfAddon.getSetting('enable-subbed')
...
def Main_menu():
    ...
    addDir('[B][COLOR white]Search[/COLOR][/B]','',6,ICON,FANART,'','','')
    addDir('[B][COLOR white]Random[/COLOR][/B]','',3,ICON,FANART,'','','')
    addDir('[B][COLOR crimson]Still in Beta (might be buggy)[/COLOR][/B]','url','',ICON,FANART,'','','')
